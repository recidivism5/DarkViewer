...
Usage: iconwriter <list of pngs> <output file name>
Example: iconwriter icon16.png icon32.png icon.ico
I use it with tcc like: tcc -run iconwriter.c icon16.png icon32.png icon48.png icon256.png icon.ico
For windows executables all you need is 16,32,48,256.
*/
